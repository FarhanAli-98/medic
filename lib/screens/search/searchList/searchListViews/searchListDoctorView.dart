...
class SearchListDoctorView extends StatefulWidget {
  @override
  _SearchListDoctorViewState createState() => _SearchListDoctorViewState();
}

class _SearchListDoctorViewState extends State<SearchListDoctorView> {
  ...
  Widget build(BuildContext context) {
    return ViewStateSelector<SearchProvider>(
      getData: () => LocatorService.searchProvider().searchDoctors(),
